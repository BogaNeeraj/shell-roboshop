...
mysql -h mysql.neeraj.sbs -uroot -pRoboShop@1 < /app/db/schema.sql &>> $LOG_FILE
mysql -h mysql.neeraj.sbs -uroot -pRoboShop@1 < /app/db/app-user.sql &>> $LOG_FILE
mysql -h mysql.neeraj.sbs -uroot -pRoboShop@1 < /app/db/master-data.sql &>> $LOG_FILE
